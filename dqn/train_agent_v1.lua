...
cmd:option('-game_path',            '/home/hongyang/project/DeepMind-Atari-Deep-Q-Learner/roms/', 'path to environment file (ROM)')
cmd:option('-env_params',           'useRGB=true', 'string of environment parameters')
cmd:option('-pool_frms',            'type="max",size=2', 'string of frame pooling parameters')
...
--
cmd:option('-name',                 'dqn_obj_det', 'filename used for saving network and training history')
cmd:option('-network',              '', 'reload pretrained network')
cmd:option('-agent',                'NeuralQLearner', 'name of agent file to use')
cmd:option('-agent_params',         '', 'string of agent parameters')       -- defined in details below
...
cmd:option('-save_freq',            125*10^3, 'the model is saved every save_freq steps')
cmd:option('-eval_freq',            25*10^4, 'frequency of greedy evaluation')
cmd:option('-save_versions',        0, '')

cmd:option('-steps',                5*10^7, 'number of training steps to perform')
cmd:option('-eval_steps',           125*10^3, 'number of evaluation steps')
...
cmd:option('-gpu',                  2, 'gpu flag')      -- start from 1
